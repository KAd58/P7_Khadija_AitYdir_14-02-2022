...
<main class="container">
    ...
    <section class="col-10 col-md-5 mt-5 mx-auto p-3 bg-light rounded">
        <form @submit.prevent="sendForm(event)">
            <p class="text-center "> <img src="../assets/signup.svg" alt="signup svg" style="width:30px"> </p>
            <h1 class="text-center font-weight-bold" style="font-size:30px;" >INSCRIPTION</h1>
            ...
            <button type="submit" class="btn btn-primary contrastBoutonNoir text-white mt-2 pt-2 w-50 border-0 rounded shadow font-weight-bold">S'INSCRIRE</button>   
           <router-link to="/#"><button type="submit" class="btn btn-primary  mt-2 w-50 shadow contrastBoutonNoir font-weight-bold">SE CONNECTER</button></router-link>
        </form>
    </section>  
    <div v-show="invalid" class="invalidBox m-2" key="invalid" style ="border-radius:60px" >
